...
/**
 * The TMA_view panel belongs to a TMARKER session. It displays a TMAspot.
 * @author Peter J. Schueffler
 */
public class TMA_view_panel extends ZoomableImagePanel {

    private tmarker t = null;
    private TMAspot ts = null;
    private Point MouseLocus = new Point(0,0);
    private final Cursor cursor_cross = new java.awt.Cursor(java.awt.Cursor.CROSSHAIR_CURSOR);
    private final Cursor cursor_default = new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR);
    private final Cursor cursor_hand = new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR);
    private final Cursor cursor_move = new java.awt.Cursor(java.awt.Cursor.MOVE_CURSOR);
    private int Image_Width;
    private int Image_Height;
    private final List<Integer> recentPolyline_x = new ArrayList<>(); // for the drawing of including or excluding areas.
    private final List<Integer> recentPolyline_y = new ArrayList<>(); // for the drawing of including or excluding areas.
    
    /** Creates new form TMAspot_panel
     * @param t The parent TMARKER session.
     */
    public TMA_view_panel(tmarker t) {
        initComponents();
        this.t = t;
        setZoomMin(0.01);
        setZoomMax(4.0);
    ...
    private void formMouseWheelMoved(java.awt.event.MouseWheelEvent evt) {//GEN-FIRST:event_formMouseWheelMoved
       t.setZoomSlider((int) (100*getZoom()));
        Rectangle r = getVisibleRect();
        double xfactor = getPreferredSize().getWidth()/getSize().getWidth();
        double yfactor = getPreferredSize().getHeight()/getSize().getHeight();
        int dx = (int)((xfactor-1)*(evt.getX()));
        int dy = (int)((yfactor-1)*(evt.getY()));
        r.translate(dx, dy);
     ...
     */
    List<Integer> getRecentPolyline_x() {
     ...
     */
    List<Integer> getRecentPolyline_y() {
